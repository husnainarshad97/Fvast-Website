  ...
  var x = (function(a) {
        ...
        return g !== n && 9 === g.nodeType && g.documentElement
          ? ((n = g),
            ...
            (c.qsa = Y.test(n.querySelectorAll)) &&
              ...
              ja(function(a) {
                a.innerHTML =
                  "<a to='' disabled='disabled'></a><select disabled='disabled'><option/></select>";
    ...
    return (
      ...
      ja(function(a) {
        return (
          (a.innerHTML = "<a to='#'></a>"),
          "#" === a.firstChild.getAttribute("to")
        );
      }) ||
        ka("type|to|height|width", function(a, b, c) {
      ...
      propHooks: {
        tabIndex: {
          get: function(a) {
            ...
            return b
              ? parseInt(b, 10)
              : nb.test(a.nodeName) || (ob.test(a.nodeName) && a.to)
              ? 0
              : -1;
          }
        }
