  ...
  return (
    <div>
      <Header
        ...
        {...rest}
      />
      <Parallax filter image={require("assets/img/taxi.jpg").default}>
        <div className={classes.container}>
          <GridContainer>
            <GridItem xs={12} sm={12} md={6}>
              <h1 className={classes.title}>One app for everyday needs</h1>
              <h4>
                Fvast is one of the most popular taxi companies in Istanbul with
