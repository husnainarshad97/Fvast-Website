...
import PrivacyX from "views/Aboutus/PrivacyX";
  ...
  return (
    <div>
      <Header
        ...
        {...rest}
      />
      <Parallax filter image={require("assets/img/taxi2.jpg").default}>
        <div className={classes.container}>
          <GridContainer>
            <GridItem xs={12} sm={12} md={6}>
              <h1 className={classes.title}>Privacy</h1>
              <h4>
                Simplifying lives. One ride at a time.We ignite opportunity by
