  ...
  return (
    <div>
      <Header
        ...
        {...rest}
      />
      <Parallax filter image={require("assets/img/taxi3.jpg").default}>
        <div className={classes.container}>
          <GridContainer>
            <GridItem xs={12} sm={12} md={6}>
              <h1 className={classes.title}>Terms & Conditions</h1>
              <h4>
                Our mission is to simplify and improve the lives of people, and
                build an awesome organisation that inspires.
              </h4>
              <br />
              {/* <Button
                color="danger"
